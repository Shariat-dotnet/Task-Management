using TaskManagement.Core.Interfaces.Http;
using Newtonsoft.Json;
using System.Net;

namespace TaskManagement.Core.Implements.Http
{    
    ...
    {        
        ...
        public int TotalPage => (int)(TotalCount / PageSize) + (TotalCount % PageSize > 0 ? 1 : 0);
    }
}
